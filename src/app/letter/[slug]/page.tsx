        ...
        {!isOpened ? (
          ...
          >
            ...
            {displayImageUrl && !imageError && (
              <div className="mb-6 relative z-10 max-w-xs sm:max-w-sm mx-auto group px-2">
                <div className="bg-white w-full p-3 sm:p-4 pb-8 sm:pb-10 shadow-xl rounded-sm transform -rotate-2 group-hover:rotate-0 transition-transform duration-500 border border-gray-100">
                  <img src={proxiedImageUrl || displayImageUrl} alt="Memory" className="w-full h-auto max-h-64 sm:max-h-72 object-cover object-center rounded-sm" loading="lazy" onError={() => setImageError(true)} />
                </div>
              </div>
            )}
